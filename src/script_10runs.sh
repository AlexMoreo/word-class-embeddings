...
log="--log-file ../log/10runs.pcaend.csv"
for run in {10..2} # 0 is for plots, 1 is already performed in hyper parameter search (in anna 1 is replicated and the last seed is 9, not 10)
do
...
#
common="--dataset-dir ../fasttext/dataset --log-file ../log/fasttext.10runs.pcaend.csv"
...
common="--dataset-dir ../fasttext/dataset --log-file ../log/fasttext.10runs.pcaend.jrcall.csv"
...
common="--dataset-dir ../fasttext/dataset --log-file ../log/fasttext.10runs.pcaend.wipo-sl-sc.csv"
