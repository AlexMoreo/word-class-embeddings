...
python main.py $log  --dataset $dataset	--net cnn	--sup-drop 0.2	--channels 512	--pretrained glove	--supervised --seed $run --max-epoch-length 300 --fullpickle ../pickles/$dataset-index.pickle
python main.py $log  --dataset $dataset	--net cnn	--channels 512	--pretrained glove	--supervised	--tunable --seed $run --max-epoch-length 300 --fullpickle ../pickles/$dataset-index.pickle
...
python main.py $log  --dataset $dataset	--net lstm	--sup-drop 0.2	--pretrained glove	--supervised --seed $run --max-epoch-length 300 --fullpickle ../pickles/$dataset-index.pickle
python main.py $log  --dataset $dataset	--net lstm	--hidden 512	--pretrained glove	--supervised	--tunable --seed $run --max-epoch-length 300 --fullpickle ../pickles/$dataset-index.pickle
...
python main.py $log  --dataset $dataset	--net attn	--sup-drop 0.2	--pretrained glove	--supervised --seed $run --max-epoch-length 300 --fullpickle ../pickles/$dataset-index.pickle
python main.py $log  --dataset $dataset	--net attn	--hidden 512	--pretrained glove	--supervised	--tunable --seed $run --max-epoch-length 300 --fullpickle ../pickles/$dataset-index.pickle
#
dataset=reuters21578
python main.py $log  --dataset $dataset	--net cnn	--learnable 200	--channels 256 --seed $run
python main.py $log  --dataset $dataset	--net cnn	--channels 256 --seed $run	--pretrained glove
python main.py $log  --dataset $dataset	--net cnn	--channels 256 --seed $run	--pretrained glove	--tunable
python main.py $log  --dataset $dataset	--net cnn	--learnable 115	--channels 256 --seed $run	--pretrained glove	--tunable
python main.py $log  --dataset $dataset	--net cnn	--channels 512 --seed $run	--pretrained glove	--supervised
python main.py $log  --dataset $dataset	--net cnn	--channels 512 --seed $run	--pretrained glove	--supervised	--tunable

python main.py $log  --dataset $dataset	--net lstm	--learnable 200 --seed $run
python main.py $log  --dataset $dataset	--net lstm	--hidden 256 --seed $run	--pretrained glove
python main.py $log  --dataset $dataset	--net lstm	--hidden 256 --seed $run	--pretrained glove	--tunable
python main.py $log  --dataset $dataset	--net lstm	--learnable 115	--hidden 256 --seed $run	--pretrained glove	--tunable
python main.py $log  --dataset $dataset	--net lstm	--hidden 256 --seed $run	--pretrained glove	--supervised
python main.py $log  --dataset $dataset	--net lstm	--hidden 256 --seed $run	--pretrained glove	--supervised	--tunable

python main.py $log  --dataset $dataset	--net attn	--learnable 200	--hidden 256 --seed $run
python main.py $log  --dataset $dataset	--net attn	--hidden 1024 --seed $run	--pretrained glove
python main.py $log  --dataset $dataset	--net attn	--hidden 1024 --seed $run	--pretrained glove	--tunable
python main.py $log  --dataset $dataset	--net attn	--learnable 115	--hidden 1024 --seed $run	--pretrained glove	--tunable
python main.py $log  --dataset $dataset	--net attn	--sup-drop 0.2	--hidden 256 --seed $run	--pretrained glove	--supervised
python main.py $log  --dataset $dataset	--net attn	--hidden 256 --seed $run	--pretrained glove	--supervised	--tunable
...
python fasttext.py --dataset jrcall $common --seed $run --pickle-path ../pickles/jrcall.pickle			--learnable 0 	--lr 0.25	--nepochs 200	--pretrained --supervised
